...
commands = {
    '1': ["verilator -Wall --trace -cc rtl/store.sv rtl/control_flow.sv rtl/core.sv rtl/pc.sv rtl/ram.sv rtl/core_execute_unit.sv rtl/alu.sv rtl/i_decoder.sv rtl/register_file.sv --top core --exe test/core_tb.cpp", 
