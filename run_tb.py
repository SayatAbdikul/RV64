...
commands = {
    '1': ["verilator -Wall --trace -cc rtl/control_flow.sv rtl/core.sv rtl/pc.sv rtl/inst_memory.sv rtl/core_execute_unit.sv rtl/alu.sv rtl/i_decoder.sv rtl/register_file.sv --top core --exe test/core_tb.cpp", 
    ...
    '4': ["verilator -Wall --trace -cc rtl/pc.sv --top pc --exe test/pc_tb.cpp",
          ...
          "./obj_dir/Vpc"],
    '5': ["verilator -Wall --trace -cc rtl/inst_memory.sv --top inst_memory --exe test/inst_memory_tb.cpp",
          "make -C obj_dir -f Vinst_memory.mk Vinst_memory",
          "./obj_dir/Vinst_memory"],
